...
type TestimonialType = {
  ...
  channel?: "Twitter" | "Google" | "YouTube" | "Github" | string;
};
      ...
      case "GitHub":
        return (
          <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            <path d="M8 0C3.58 0 0 3.58 0 8a8 8 0 005.47 7.59c.4.07.55-.17.55-.38v-1.33C3.76 14.91 3.3 13.65 3.3 13.65c-.36-.91-.88-1.15-.88-1.15-.72-.49.05-.48.05-.48.79.06 1.2.81 1.2.81.71 1.2 1.87.85 2.33.65.07-.52.28-.85.5-1.05-2.66-.3-5.47-1.33-5.47-5.93 0-1.31.47-2.38 1.24-3.22-.13-.3-.54-1.52.12-3.17 0 0 1.01-.32 3.3 1.23a11.52 11.52 0 016 0C12.7 1.22 13.7 1.54 13.7 1.54c.66 1.65.25 2.87.12 3.17.77.84 1.23 1.91 1.23 3.22 0 4.61-2.81 5.63-5.49 5.92.29.25.54.73.54 1.48v2.2c0 .21.15.46.55.38A8.001 8.001 0 008 0z"/>
          </svg>
        );
      default:
        return null;
