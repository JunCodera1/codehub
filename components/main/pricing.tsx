      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-sans mb-4">Let's find the right plan for you business</h2>
            <p className="text-xl text-slate-500">
              Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est.
            </p>
          </div>
          {/* Pricing tables */}
          <div className="grid md:grid-cols-6 drop-shadow-md rounded">
            {/* Pricing toggle */}
            <div className="flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:col-span-3">
            ...
            {/* Starter price */}
            <div className="flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-1 md:order-none md:text-center mt-6 md:mt-0">
              <div className="font-sans text-lg font-bold text-indigo-500 mb-0.5">Starter</div>
              <div>
            ...
            {/* Agency price */}
            <div className="flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-2 md:order-none md:text-center mt-6 md:mt-0">
              <div className="font-sans text-lg font-bold text-indigo-500 mb-0.5">Agency</div>
              <div>
            ...
            {/* Team price */}
            <div className="flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-3 md:order-none md:text-center mt-6 md:mt-0">
              <div className="font-sans text-lg font-bold text-indigo-500 mb-0.5">Team</div>
              <div>
            ...
            {/* Admins & Members */}
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:col-span-3">
              <div className="text-slate-800">Admins &amp; Members</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-1 md:order-none">
            ...
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-2 md:order-none">
              <div className="md:hidden text-slate-800">Admins &amp; Members</div>
              <div className="text-sm font-medium text-slate-800 text-center">12</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-3 md:order-none">
              <div className="md:hidden text-slate-800">Admins &amp; Members</div>
              <div className="text-sm font-medium text-slate-800 text-center">Unlimited</div>
            </div>
            {/* File Storage */}
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:col-span-3">
              <div className="text-slate-800">File Storage</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:border-l border-slate-700 order-1 md:order-none">
            ...
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:border-l border-slate-700 order-2 md:order-none">
              <div className="md:hidden text-slate-800">File Storage</div>
              <div className="text-sm font-medium text-slate-800 text-center">50GB</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:border-l border-slate-700 order-3 md:order-none">
              <div className="md:hidden text-slate-800">File Storage</div>
              <div className="text-sm font-medium text-slate-800 text-center">Unlimited</div>
            </div>
            {/* Active Users */}
            ...
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:col-span-3">
              <div className="text-slate-800">Unlimited Activities</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-1 md:order-none">
              <div className="md:hidden text-slate-800">Unlimited Activities</div>
            ...
            {/* Data Export */}
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:col-span-3">
              <div className="text-slate-800">Data Export</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 bg-opacity-70 md:border-l border-slate-700 order-1 md:order-none">
              <div className="md:hidden text-slate-800">Data Export</div>
              <div className="text-sm font-medium text-slate-800 text-center">
            ...
            {/* Adjust Group Sizes */}
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-200 md:col-span-3">
              <div className="text-slate-800">Adjust Group Sizes</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-200 md:border-l border-slate-700 order-1 md:order-none">
              <div className="md:hidden text-slate-800">Adjust Group Sizes</div>
              <div className="text-sm font-medium text-slate-800 text-center">
                <svg className="inline-flex fill-slate-500" width="14" height="2" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 0v2H0V0z" fillRule="evenodd" />
                </svg>
